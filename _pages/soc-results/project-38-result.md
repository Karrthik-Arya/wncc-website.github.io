...
permalink: /soc-results/project-38-result
---
...
<div class="mentor-mentee-section">
    ...
    <h4 class="mentors" style="display: inline;">Rishabh Arya, Latika Patel</h4>    
    <br>  <br>
    <h4 class="mentor-title" style="display: block;">Mentees</h4> 
    <h4 class="mentors" style="display: inline;">Laxman Desai, Rishikesh Gunjal</h4>
    </div>
