...
<h2 class="display1 m-3 p-3 text-center blog-col">{{page.project_name}}</h2>
{% for project in site.data.settings.blog-items %}
{% if project.title == page.project %}
<p>
<div class = "d-flex justify-content-between" style="margin-top:;">
...
<div class = "author-details">- Bhaskar Gupta <br> IIT Bombay (CSE) <br> 4th Year, B.Tech</div>
</div>
</div>
</p>
<div>
